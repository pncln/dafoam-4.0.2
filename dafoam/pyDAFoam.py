...
class DAOPTION(object):
    ...
    def __init__(self):
        ...
        ## - DASonicPimpleFoam:       Compressible supersonic flow solver with shock capturing capabilities
...
class PYDAFOAM(object):
    ...
    def _solverRegistry(self):
        ...
        self.solverRegistry = {
            ...
            "Compressible": ["DARhoSimpleFoam", "DARhoSimpleCFoam", "DATurboFoam", "DARhoPimpleFoam", "DASonicPimpleFoam"],
